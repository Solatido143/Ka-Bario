    ...
    <div class="row">
        <div class="col">
            <div class="navbar navbar-expand-lg">
                <p class="h2 text-lg-center text-xl-center d-inline-block">Edit List</p>
            </div>
        </div>
    </div>
    <div class="row">
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class='text-nowrap'>
                                                    <a href='useredit.php?uid=<?= $user->uid ?>&key=<?= $key ?>' class='btn btn-success'>Edit</i></a>
                                                </td>
                                                <td class='text-nowrap'>
                                    ...
                                    foreach ($authUsers as $user) {
                                        ...
                                        if ($userRecord && $userRecord['residentialAddress']['barangay'] == $logged_in_user_data['residentialAddress']['barangay']) {
                                            ...
                                            if (!isset($claims['super_admin']) && !isset($claims['admin'])) {
